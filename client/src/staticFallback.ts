export const fallbackProfileData = {
  personalInfo: {
  ...
  skills: [
    { name: "Java", category: "Programming" as const, level: 92, icon: "Code2" },
    { name: "C", category: "Programming" as const, level: 85, icon: "Terminal" },
    { name: "Python", category: "Programming" as const, level: 80, icon: "Terminal" },
    { name: "JavaScript", category: "Programming" as const, level: 88, icon: "FileJson" },
    { name: "React.js", category: "Frontend" as const, level: 90, icon: "React" },
    { name: "HTML", category: "Frontend" as const, level: 95, icon: "FileCode" },
    { name: "CSS", category: "Frontend" as const, level: 92, icon: "Paintbrush" },
    { name: "Bootstrap", category: "Frontend" as const, level: 85, icon: "Grid" },
    { name: "Responsive Design", category: "Frontend" as const, level: 95, icon: "Globe" },
    { name: "Node.js", category: "Backend" as const, level: 85, icon: "Node" },
    { name: "Express.js", category: "Backend" as const, level: 85, icon: "Server" },
    { name: "RESTful APIs", category: "Backend" as const, level: 90, icon: "Cpu" },
    { name: "JWT Authentication", category: "Backend" as const, level: 85, icon: "Shield" },
    { name: "Role-Based Access", category: "Backend" as const, level: 88, icon: "Shield" },
    { name: "MySQL", category: "Databases" as const, level: 85, icon: "Database" },
    { name: "MongoDB", category: "Databases" as const, level: 88, icon: "Database" },
    { name: "Vercel", category: "Tools" as const, level: 82, icon: "Layers" },
    { name: "Netlify", category: "Tools" as const, level: 80, icon: "Layers" },
    { name: "Git", category: "Tools" as const, level: 90, icon: "GitBranch" },
    { name: "GitHub", category: "Tools" as const, level: 90, icon: "Github" },
    { name: "Power BI", category: "Tools" as const, level: 80, icon: "Layers" },
    { name: "Postman", category: "Tools" as const, level: 85, icon: "Send" },
    { name: "VS Code", category: "Tools" as const, level: 92, icon: "Laptop" },
    { name: "Axios", category: "Tools" as const, level: 88, icon: "Send" },
    { name: "Data Structures", category: "Programming" as const, level: 92, icon: "GitCommit" },
    { name: "Algorithms", category: "Programming" as const, level: 90, icon: "TrendingUp" },
    { name: "Object-Oriented Programming", category: "Programming" as const, level: 88, icon: "Code2" },
    { name: "Database Management System", category: "Databases" as const, level: 85, icon: "Database" }
  ],
  projects: [
    {
...
CRDTs are transforming peer-to-peer architectures.
      `
    }
  ]
};
